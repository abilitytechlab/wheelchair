...
class ObstacleDetector : public rclcpp::Node
{
  ...
  private:
    ...
    {   
      ...
      bool frontLeftObstacle = scanner.checkObstacleInFilteredData(frontLeftScan,0.75);
      bool frontRightObstacle = scanner.checkObstacleInFilteredData(frontRightScan,0.75);
      ...
      bool leftObstacle = scanner.checkObstacleInFilteredData(leftScan,0.75);
      float left = (leftObstacle == true) ? 1 : 0;

      bool rightObstacle = scanner.checkObstacleInFilteredData(rightScan,0.75);
