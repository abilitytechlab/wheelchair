...
class keyboardInput : public rclcpp::Node
{
  ...
  keyboardInput() : Node("keyboard_input"){
    keypublisher_ = this->create_publisher<std_msgs::msg::String>("userinput", rclcpp::QoS(rclcpp::KeepLast(1)).best_effort().durability_volatile());
  ...
  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr keypublisher_;
  bool data_bit_;
